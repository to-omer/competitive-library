...
/// $+$
#[snippet::entry("AdditiveOperation")]
#[derive(Clone, Copy, Debug, Default, Eq, Hash, Ord, PartialEq, PartialOrd)]
...
/// $\times$
#[snippet::entry("MultiplicativeOperation")]
#[derive(Clone, Copy, Debug, Default, Eq, Hash, Ord, PartialEq, PartialOrd)]
...
#[snippet::entry("MonoidalOperation")]
#[derive(Clone, Debug)]
...
#[snippet::entry("AssocoativeOperator")]
#[derive(Clone, Debug)]
...
/// $(M_1, M_2)$
#[snippet::entry("CartesianOperation")]
#[derive(Clone, Debug)]
...
#[snippet::entry("CountingOperation")]
#[derive(Clone, Debug)]
...
#[snippet::entry("ReverseOperation")]
#[derive(Clone, Debug)]
