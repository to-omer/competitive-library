...
fn bench_header(suite: usize) {
    ...
    println!(
        "benchmark=competitive_simd_methods_v6 suite={suite} seed={BENCH_SEED} rounds={BENCH_ROUNDS} calibration_target_ns={BENCH_TARGET_SAMPLE_NS} timer={timer} order=alternating arch={} os={} pointer_bits={} bmi2={bmi2} avx2={avx2} avx512f={avx512f} avx512vl={avx512vl}",
        std::env::consts::ARCH,
        std::env::consts::OS,
        usize::BITS,
    );
