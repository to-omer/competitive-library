...
fn bench_memory_core() {
    let n = (1 << 20) + 123;
    println!(
        "benchmark=competitive_simd_memory_v2 n={n} arch={} pointer_bits={}",
        std::env::consts::ARCH,
        usize::BITS
    );
...
fn bench_memory_wavelet_existing() {
    let n = (1 << 15) + 123;
    println!(
        "benchmark=competitive_simd_memory_wavelet_existing_v2 n={n} arch={} pointer_bits={}",
        std::env::consts::ARCH,
        usize::BITS
    );
    bench_memory("WaveletMatrixU32", || {
...
fn bench_memory_radix_widths() {
    ...
    let n = (1 << 20) + 123;
    println!(
        "benchmark=competitive_simd_memory_radix_widths_v2 n={n} arch={} pointer_bits={} signed_layout=identical_after_sign_bit_encoding",
        std::env::consts::ARCH,
        usize::BITS
    );
